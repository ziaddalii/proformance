...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0 z-10">
      ...
      <p className="max-w-2xl text-base md:text-xl text-slate-400 mt-8">
...
export const FeatureCard = ({
  ...
  return (
    <motion.div
      ...
      key={feature.title}
      className="group/feature relative bg-[#00000074] md:w-[30rem] w-[20rem] text-center md:p-8 px-4 pt-8 flex-shrink-0 rounded-2xl"
    >
